    ...
    <div style={styles.container}>
      ...
      <nav style={styles.navbar}>
        <div style={styles.navContent}>
          ...
          <div style={styles.navButtons}>
            {/* NEW: Templates link (public) */}
            <Link to="/templates" style={styles.navLoginButton}>
              Templates
            </Link>
      ...
      <div style={styles.content}>
        ...
        <div style={styles.features}>
          {/* Wrapped first card with Link to /templates */}
          <Link to="/templates" style={{ textDecoration: 'none', display: 'block' }} aria-label="Open Templates">
            <div
              style={{ ...styles.feature, cursor: 'pointer' }}
              onMouseEnter={(e) => {
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  logo: { fontSize: '24px', fontWeight: '800', color: 'white', margin: 0, letterSpacing: '-0.5px' },
  logoTagline: {
    fontSize: '11px',
  ...
  heroBadgeIcon: { fontSize: '14px' },
  heroBadgeText: { fontSize: '12px', fontWeight: '600', letterSpacing: '0.3px' },
  title: { fontSize: '44px', fontWeight: '900', marginBottom: '16px', lineHeight: '1.2', letterSpacing: '-1px' },
  titleHighlight: {
  ...
  featureTitle: { fontSize: '18px', fontWeight: '700', marginBottom: '8px', color: '#1a202c' },
  featureText: { fontSize: '14px', color: '#4a5568', lineHeight: '1.6', marginBottom: '12px' },
  featureHighlight: {
    display: 'inline-block',
    padding: '4px 12px',
