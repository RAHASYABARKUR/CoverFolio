...
class Experience(models.Model):
    ...
    location = models.CharField(max_length=100, blank=True)
    start_date = models.CharField(max_length=50, null=True, blank=True) #models.DateField()
    end_date =  models.CharField(max_length=50, null=True, blank=True) #models.DateField(null=True, blank=True, help_text="Leave blank if currently enrolled")
